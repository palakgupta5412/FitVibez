...
Source: https://sketchfab.com/3d-models/gym-equipment-0582bd07f01b49b09b3552553c3467b8
Title: Gym Equipment
*/
...
const Gym = (props) =>{
  const { nodes, materials } = useGLTF('/models/gym_equipment.glb')
...
useGLTF.preload("/models/gym_equipment.glb")
export default Gym ;
